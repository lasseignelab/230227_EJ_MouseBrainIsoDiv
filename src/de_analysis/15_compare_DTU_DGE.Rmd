...
stacked_barplot <- data.frame(
  ...
  "analysis" = rep(c("DGE", "DTE", "DTU", "DGE and DTE", "DGE and DTU", "DTE and DTU", "all"), 4),
  "n_genes" = c(
    length(cerebellum_dge_genes),
    length(cerebellum_dte_genes),
    length(cerebellum_dtu_genes),
    ...
    length(cortex_dte_genes),
    length(cortex_dtu_genes),
    length(intersect(cortex_dge_genes, cortex_dte_genes)),
    length(intersect(cortex_dge_genes, cortex_dtu_genes)),
    length(intersect(cortex_dtu_genes, cortex_dte_genes)),
