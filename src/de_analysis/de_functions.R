...
get_de_results <- function(tissue1, tissue2, save_path) {
  ...
  saveRDS(temp_results, here(save_path, paste0(
    tissue1, "_",
    tissue2,
    "_results.Rds"
  )))
...
get_de_results_transcripts <- function(tissue1, tissue2, save_path) {
