...
The purpose of this script is to examine differential transcript usage by sex in short-read c elegans data. I am especially interested in comparing this DTU to my own mouse data to look for evolutionary conserved genes with sex specific splicing. The entire script takes less than 10 minutes to run. Must be run in at least docker 1.3 to include c elegans annotation.
