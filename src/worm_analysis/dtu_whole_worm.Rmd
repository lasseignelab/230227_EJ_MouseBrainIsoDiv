...
The purpose of this script is to examine differential transcript usage by sex in short-read c elegans data.
...
Now, we can create a switchlist.
...
```{r tidy script}
style_file("dtu_whole_worm.Rmd")

lint("dtu_whole_worm.Rmd",
