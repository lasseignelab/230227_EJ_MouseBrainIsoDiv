...
transcripts_annotation <- annotation[annotation$type == "transcript",]
```
...
I also want to have more location about these novel genes, such as their chromosomal locations. I can get this from the annotation gtf.

```{r pull novel genes from annotation}

novel_genes_annotation <- annotation[annotation]
