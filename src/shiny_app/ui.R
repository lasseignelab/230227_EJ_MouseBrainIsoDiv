...
welcome_about <- tabPanel(
  ...
  br(),
  div(
    h2("Long-read Mouse Brain RNA-Seq Comparisons and Visualizations"),
    p(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      p(
        ...
        "Alternatively, you can download the processed data to plot yourself!",
        "Gene and isoform expression values are in counts per million (CPM)."
      ),
      selectizeInput(
        inputId = "gene_name1",
