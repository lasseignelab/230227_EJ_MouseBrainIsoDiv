...
plot_iso_expression(top_saturn_genes[1])
plot_iso_expression(top_saturn_genes[2])
plot_iso_expression(top_saturn_genes[3])
plot_iso_expression(top_saturn_genes[4])
plot_iso_expression(top_saturn_genes[5])
plot_iso_expression(top_saturn_genes[6])
plot_iso_expression(top_saturn_genes[7])
plot_iso_expression(top_saturn_genes[8])
plot_iso_expression(top_saturn_genes[9])
plot_iso_expression(top_saturn_genes[10])
