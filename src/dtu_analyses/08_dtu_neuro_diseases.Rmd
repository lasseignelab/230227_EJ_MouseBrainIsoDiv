...
Now, I am going to pull in CPAM case genes from Lizzy. Note for publishing, we might not want to include this file in the public repo if private.
...
```{r run analysis}
# prep significant gene lists and compare
lapply(seq_along(region_all_switchlist_analyzed), compare_switching_genes) 
# warning: function only prints last result (cpam)
```
...
saveRDS(
  all_psych_genes,
  here("results", "psych_dtu_genes", "all_psych_genes.Rds")
)
