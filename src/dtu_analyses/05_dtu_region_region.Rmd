...
saveRDS(
  ...
  here("data", "switchlist_objects", "raw", "region_region_switchlist_analyzed.Rds")
)
```
...
# make UpSet plot (ComplexHeatmap)
pdf(here("results", "tcResults", "plots", "upset_plots", "region_region_upset.pdf"),
    width = 12, height = 6
)
...
cerebellum_cortex_volcano <- create_volcano_plot_comp(
  switchlist = region_region_switchlist_analyzed,
  condition1 = "cerebellum",
  condition2 = "cortex"
)

cerebellum_hippocampus_volcano <- create_volcano_plot_comp(
  switchlist = region_region_switchlist_analyzed,
  condition1 = "cerebellum",
  condition2 = "hippocampus"
)

cerebellum_striatum_volcano <- create_volcano_plot_comp(
  switchlist = region_region_switchlist_analyzed,
  condition1 = "cerebellum",
  condition2 = "striatum"
)

cortex_hippocampus_volcano <- create_volcano_plot_comp(
  switchlist = region_region_switchlist_analyzed,
  condition1 = "cortex",
  condition2 = "hippocampus"
)

cortex_striatum_volcano <- create_volcano_plot_comp(
  switchlist = region_region_switchlist_analyzed,
  condition1 = "cortex",
  condition2 = "striatum"
)

hippocampus_striatum_volcano <- create_volcano_plot_comp(
  switchlist = region_region_switchlist_analyzed,
