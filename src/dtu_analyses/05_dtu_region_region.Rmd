...
I also can indicate not just overlapping, but specifically which genes are DTU and have overlap. So, I want to get a list of genes for each comparison.
...
```{r gprofiler2}
run_plot_gprofiler(
  tissue_obj = sig_isoform_genes_cere_cort,
  save_path = here("results", "plots", "gprofiler2")
)

run_plot_gprofiler(
  tissue_obj = sig_isoform_genes_cere_hipp,
  save_path = here("results", "plots", "gprofiler2")
)

run_plot_gprofiler(
  tissue_obj = sig_isoform_genes_cere_stri,
  save_path = here("results", "plots", "gprofiler2")
)

run_plot_gprofiler(
  tissue_obj = sig_isoform_genes_cort_hipp,
  save_path = here("results", "plots", "gprofiler2")
)

run_plot_gprofiler(
  tissue_obj = sig_isoform_genes_cort_stri,
  save_path = here("results", "plots", "gprofiler2")
)

run_plot_gprofiler(
  tissue_obj = sig_isoform_genes_hipp_stri,
  save_path = here("results", "plots", "gprofiler2")
)
```
