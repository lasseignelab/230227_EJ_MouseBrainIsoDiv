...
sig_overlap_list <- list(
  `cerebellum vs. cortex` = na.omit(sig_isoform_genes_cere_cort),
  `cerebellum vs. hippocampus` = na.omit(sig_isoform_genes_cere_hipp),
  `cerebellum vs. striatum` = na.omit(sig_isoform_genes_cere_stri),
  `cortex vs. hippocampus` = na.omit(sig_isoform_genes_cort_hipp),
  `cortex vs. striatum` = na.omit(sig_isoform_genes_cort_stri),
  `hippocampus vs. striatum` = na.omit(sig_isoform_genes_hipp_stri)
)
```
...
# make UpSet plot (ComplexHeatmap)
pdf(here("results", "plots", "upset_plots", "region_region_upset.pdf"), width = 12, height = 6)
...
```{r gprofiler2}
run_plot_gprofiler(sig_isoform_genes_cere_cort, here("results", "plots", "gprofiler2"))
run_plot_gprofiler(sig_isoform_genes_cere_hipp, here("results", "plots", "gprofiler2"))
run_plot_gprofiler(sig_isoform_genes_cere_stri, here("results", "plots", "gprofiler2"))
run_plot_gprofiler(sig_isoform_genes_cort_hipp, here("results", "plots", "gprofiler2"))
run_plot_gprofiler(sig_isoform_genes_cort_stri, here("results", "plots", "gprofiler2"))
run_plot_gprofiler(sig_isoform_genes_hipp_stri, here("results", "plots", "gprofiler2"))
```
