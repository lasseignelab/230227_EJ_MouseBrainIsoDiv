...
saveRDS(cpm_switchlist_dexseq, here("data", "switchlist_objects",
...
# use function to filter genes
lapply(all_regions, filter_genes)
...
comparison_arg_2 <- c("cortex", "hippocampus", "striatum", "hippocampus", "striatum", "striatum")
# make function to get list of genes for each comparison
...
# use function on all comparisons
mapply(create_volcano_plot, comparison_arg_1, comparison_arg_2)
```
...
run_plot_gprofiler(sig_isoform_genes_cort_hipp) # not significant, may need to skip
