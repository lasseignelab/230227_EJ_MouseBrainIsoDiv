...
# now run DEXSeq
region_region_switchlist_analyzed <- isoformSwitchTestDEXSeq(
...
saveRDS(region_region_switchlist_analyzed, here(
  "data", "switchlist_objects",
...
region_region_switchlist_analyzed_nobatch <- isoformSwitchTestDEXSeq(
  switchAnalyzeRlist = region_region_switchlist_nobatch,
  reduceToSwitchingGenes = TRUE
)

extractSwitchSummary(region_region_switchlist_analyzed_nobatch)
...
```
Expected DEXSeq output:


Expected saturn output:
