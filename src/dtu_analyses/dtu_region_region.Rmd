...
create_volcano_plot <- function(x, y) {
  ...
  ggsave(paste0("../plots/DEXSeq_volcano/", x, "_vs_", y, "_cpm_volcano.png"), width = 6, height = 4)
...
ggsave("../plots/gprofiler_results/cere_ctx_cpm_gprofiler.png", width = 6, height = 4)
...
ggsave("../plots/gprofiler_results/cere_hip_cpm_gprofiler.png", width = 6, height = 4)
...
ggsave("../plots/gprofiler_results/cere_stm_cpm_gprofiler.png", width = 6, height = 4)
