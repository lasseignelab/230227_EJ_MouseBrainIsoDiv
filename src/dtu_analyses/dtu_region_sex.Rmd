...
sex_switchlist <- importRdata(
    isoformCountMatrix   = merged_raw_counts,
...
#cerebellum
cere_raw_counts <- subset(merged_raw_counts, select = c("isoform_id", sample_collection_metadata$sample_id[sample_collection_metadata$tissue == "cerebellum"]))
cere_tpm <- subset(tpm, select = c("isoform_id", sample_collection_metadata$sample_id[sample_collection_metadata$tissue == "cerebellum"]))
cere_tpm <- cere_tpm[rowSums(cere_tpm[,-1]) != 0,]

#cortex
ctx_raw_counts <- subset(merged_raw_counts, select = c("isoform_id", sample_collection_metadata$sample_id[sample_collection_metadata$tissue == "cortex"]))
ctx_tpm <- subset(tpm, select = c("isoform_id", sample_collection_metadata$sample_id[sample_collection_metadata$tissue == "cortex"]))
ctx_tpm <- ctx_tpm[rowSums(ctx_tpm[,-1]) != 0,]

#hippocampus 
hip_raw_counts <- subset(merged_raw_counts, select = c("isoform_id", sample_collection_metadata$sample_id[sample_collection_metadata$tissue == "hippocampus"]))
hip_tpm <- subset(tpm, select = c("isoform_id", sample_collection_metadata$sample_id[sample_collection_metadata$tissue == "hippocampus"]))
hip_tpm <- hip_tpm[rowSums(hip_tpm[,-1]) != 0,]

#striatum 
stm_raw_counts <- subset(merged_raw_counts, select = c("isoform_id", sample_collection_metadata$sample_id[sample_collection_metadata$tissue == "striatum"]))
stm_tpm <- subset(tpm, select = c("isoform_id", sample_collection_metadata$sample_id[sample_collection_metadata$tissue == "striatum"]))
stm_tpm <- stm_tpm[rowSums(stm_tpm[,-1]) != 0,]
```
...
cere_sex_switchlist <- importRdata(
    isoformCountMatrix   = cere_raw_counts,
    isoformRepExpression = cere_tpm,
...
ctx_sex_switchlist <- importRdata(
  isoformCountMatrix   = ctx_raw_counts,
  isoformRepExpression = ctx_tpm,
...
hip_sex_switchlist <- importRdata(
  isoformCountMatrix   = hip_raw_counts,
  isoformRepExpression = hip_tpm,
...
stm_sex_switchlist <- importRdata(
  isoformCountMatrix   = stm_raw_counts,
  isoformRepExpression = stm_tpm,
