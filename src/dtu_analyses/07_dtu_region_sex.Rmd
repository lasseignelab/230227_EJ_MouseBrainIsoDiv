...
bg_genes <- unique(sex_switchlist$isoformFeatures$gene_id)
bg_genes <- str_extract(combined_bg_genes, "ENSMUSG...........")
```
...
```{r go analysis}
run_plot_gprofiler(
  gene_list = region_sex_sig_genes_list$cerebellum,
  name = "cerebellum_sex",
  save_path = here("results", "tcResults", "plots", "gprofiler2")
)
```
