...
lapply(all_regions, make_switchlist_run_saturn)
```
...
png(here("results", "plots", "upset_plots", "region_others_gene_upset.png"))
...
# make UpSet plot (ComplexHeatmap)
png(here("results", "plots", "upset_plots", "region_others_isoform_upset.png"))
upset_isoform <- UpSet(
...
Estimated processing time was 9 minutes.
