...
wget -P ../../data/gencode_annotations https://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_mouse/release_M31/#:~:text=gencode.vM31.primary_assembly.annotation.gtf.gz
